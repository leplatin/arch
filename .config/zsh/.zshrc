...
source ~/.config/zsh/powerlevel10k/gitstatus/gitstatus.prompt.zsh
# source ~/.config/zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh #must be the last plugin sourced
